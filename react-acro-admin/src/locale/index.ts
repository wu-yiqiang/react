const i18n = {
  'en-US': {
    ...
    'menu.system.permission': 'Permission Admin',
    'menu.system.menu': 'Menu Admin',
    'menu.system.user': 'User Admin',
    ...
    'settings.rightNavbar': 'Right Navbar',
