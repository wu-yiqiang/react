import { Form, Input, Modal, Upload, Select, Row, Col, Spin } from 'antd'
              ...
              <Col span={12}>
                <Form.Item label="头像" name="avatar">
                  <Upload name="avatar" listType="picture-card" className="avatar-uploader" accept=".jpg,.jpeg,.png" showUploadList={false} beforeUpload={(file: File) => beforeUpload(file)} customRequest={handleUpload}>
                    {form?.getFieldValue('avatar') ? <img src={form?.getFieldValue('avatar')} alt="avatar" style={{ width: '100%' }} /> : uploadButton}
                  </Upload>
                </Form.Item>
              </Col>
            </Row>
